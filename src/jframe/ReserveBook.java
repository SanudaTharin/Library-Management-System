...
public class ReserveBook extends javax.swing.JFrame {
    ...
    public boolean reserveBook(){
        ...
        if (hasExistingIssuedCopy()) {
            JOptionPane.showMessageDialog(this, "You already have an issued copy for this book.");
            return false;
        }
    ...
    public boolean hasExistingIssuedCopy() {
        boolean hasExistingCopy = false;
        int studentId = Integer.parseInt(txt_studentId.getText());
        int bookId = Integer.parseInt(txt_bookId.getText());

        try {
            Connection con = DBConnection.getConnection();
            String sql = "SELECT * FROM issue_book_details WHERE student_id = ? AND book_id = ? AND status = 'Pending'";
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setInt(1, studentId);
            pst.setInt(2, bookId);
    ...
    private void initComponents() {
        ...
        jPanel4.add(lbl_bookName, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 330, 240, -1));
        ...
        jPanel20.setBackground(new java.awt.Color(68, 158, 164));
        ...
        panel_main.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1180, 200, 230, 3));
        ...
        rSMaterialButtonCircle2.setText("Reserve");
        ...
        if(lbl_quantity.getText().equals("0")){
            ...
            if(isAlreadyReserved() == false){
                if (reserveBook() == true){
                    ...
                    JOptionPane.showMessageDialog(this, "Can't Reserve the Book");
                }
            }else {
